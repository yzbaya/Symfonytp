 ...
 */
final class Version20230328203813 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD category_id INT NOT NULL, CHANGE prix prix INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP category_id, CHANGE prix prix NUMERIC(11, 0) NOT NULL');
    }
}
